...
INSERT INTO crm_settings (key, value) VALUES
  ...
  ('discovery_auto_find_keywords', '"pub with parking, country inn, farm shop, vineyard, rural hotel, scenic viewpoint, nature reserve, beauty spot, country park, river walk"'),
