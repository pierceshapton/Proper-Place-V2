...
export default function BrowsePage() {
  ...
  return (
    <main className="flex flex-col -mt-24">
      {/* Map Container - full height below navbar */}
      <div className="h-screen pt-28 relative">
        {!isLoaded || isLoading ? (
          <div className="absolute inset-0 pt-28 flex items-center justify-center bg-gray-100">
          ...
          <>
            ...
            <div className="absolute top-[56px] left-2">
              <button
            ...
            <div className="absolute top-[112px] left-2">
              <button
