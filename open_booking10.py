#!/usr/bin/env python3
"""Open booking ID 10 detail screenshot."""
import asyncio
import json
import subprocess
import websockets
...
async def main():
    async with websockets.connect(VM_URL) as ws:
        ...
        # Go to bookings tab
        print("1. Switch to Bookings tab...")
        await evaluate("goToTab(1)", wait=2.0)

        # Open booking #10 (place_id=22, both valid)
        print("2. Opening booking ID 10 (PP-260325-0010)...")
        await evaluate("openBooking(10)", wait=7.0)
